...
var _DataManager = __webpack_require__(10);

var _DataManager2 = _interopRequireDefault(_DataManager);

var _AtmosphereManager = __webpack_require__(8);

var _AtmosphereManager2 = _interopRequireDefault(_AtmosphereManager);

var _TrackManager = __webpack_require__(15);
...
var _PersistenceManager = __webpack_require__(13);

var _PersistenceManager2 = _interopRequireDefault(_PersistenceManager);

var _DragManager = __webpack_require__(11);
    ...
    */
    ...
    _createClass(GlobalVars, [{
        ...
        */
        ...
        key: 'convertToFilenames',
        value: function convertToFilenames(filename) {
            var filenames = [],
                that = this;
    ...
    */
    ...
    _createClass(Track, [{
        ...
        value: function createElement() {
            ...
            $trackHTML.on('pointerenter', function () {
            ...
            }.bind(this)).on('pointerleave', function () {
...
var SearchBar = function () {
    function SearchBar() {
        ...
        this.$results = (0, _jquery2.default)("#searchResults"); // the ul containing all search results
...
var _OneShot = __webpack_require__(12);
    ...
    _createClass(Atmosphere, [{
        ...
        value: function createElement() {
            ...
            $atmosphereHTML.find(".btn--drag").on("pointerdown", function (e) {
                _GlobalVars.g.dragManager.startDraggingAtmosphere(this, e);
            }.bind(this));
        ...
        value: function toggleTitleEditable($titleText) {
            ...
            _GlobalVars.g.atmosphereManager.stopEditingTitle(); // clear any title currently being edited
        ...
        */
        ...
        value: function _delete() {
            ...
            _GlobalVars.g.atmosphereManager.removeAtmosphereFromArray(this);
            // Update localStorage
            _GlobalVars.g.pm.storeAtmospheres();
        }
    }, {
...
var _Atmosphere = __webpack_require__(7);
    ...
    _createClass(AtmosphereManager, [{
        ...
        value: function events() {
            ...
            (0, _jquery2.default)(document).click(function (event) {
                if (this.$editingTitle != null && !this.$editingTitle.is(event.target) && this.$editingTitle.has(event.target).length === 0) {
        ...
        key: 'deselectActiveAtmosphere',
        value: function deselectActiveAtmosphere() {
        ...
        key: 'removeAtmosphereFromArray',
        value: function removeAtmosphereFromArray(atmosphere) {
        ...
        key: 'getPositionInArray',
        value: function getPositionInArray(atmosphere) {
        ...
        key: 'moveAtmosphereAtPosition',
        value: function moveAtmosphereAtPosition(currentIndex, insertIndex) {
...
var AudioManager = function () {
    ...
    _createClass(AudioManager, [{
        ...
        key: 'addOneShotSet',
        value: function addOneShotSet(id, howls) {
            this.audio[id] = howls;
        }
    }, {
        key: 'playTrack',
        ...
        key: 'calculateVolume',
        value: function calculateVolume(trackVolume) {
            return _GlobalVars.g.atmosphereManager.muteMultiplier // Whether global mute is checked
        ...
        key: 'isOneShot',
        value: function isOneShot(track) {
    ...
    _createClass(DataManager, [{
        ...
        */
        ...
        value: function generateResultHTML(object, type) {
            ...
            return (0, _jquery2.default)(resultHTML).appendTo(_GlobalVars.g.searchBar.$results);
        }
    }, {
        key: 'rigResultEvents',
    ...
    */
    ...
    _createClass(DragManager, [{
        ...
        value: function events() {
            ...
            (0, _jquery2.default)('html').on('pointermove', function (e) {
...
var _startMinIndex = 3; // the index of the default minimum timestep
var _startMaxIndex = 4; // the index of the default maximum timestep

var OneShot = function (_Track) {
    _inherits(OneShot, _Track);

    _createClass(OneShot, null, [{
        key: 'timesteps',
        get: function get() {
            return _OneShotTimesteps2.default;
        }
    }, {
        key: 'startMinIndex',
        get: function get() {
    ...
    _createClass(OneShot, [{
        ...
        key: 'createElement',
        value: function createElement() {
            _get(OneShot.prototype.__proto__ || Object.getPrototypeOf(OneShot.prototype), 'createElement', this).call(this);
        ...
        value: function createAudio(trackData) {
            ...
            this.data.samples.forEach(function (sample) {
                paths = _GlobalVars.g.convertToFilenames(sample.filename); // prepend path and append track postfixes to the sample name
    ...
    _createClass(Sidebar, [{
        ...
        value: function events() {
            ...
            this.$HTML.on('click', function (e) {
                _GlobalVars.g.atmosphereManager.deselectActiveAtmosphere();
            }.bind(this));
...
(function () {
  ...
  templates['atmosphere.hbs'] = template({ "compiler": [8, ">= 4.3.0"], "main": function main(container, depth0, helpers, partials, data) {
      var helper,
...
(function () {
  ...
  templates['oneshot.hbs'] = template({ "1": function _(container, depth0, helpers, partials, data) {
      ...
      return "            <span>Source:\r\n                <span class=\"source\">" + container.escapeExpression((helper = (helper = lookupProperty(helpers, "source") || (depth0 != null ? lookupProperty(depth0, "source") : depth0)) != null ? helper : container.hooks.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : container.nullContext || {}, { "name": "source", "hash": {}, "data": data, "loc": { "start": { "line": 32, "column": 37 }, "end": { "line": 32, "column": 47 } } }) : helper)) + "</span>\r\n            </span><br>\r\n";
      ...
      return "            <span class=\"tags\">Tags:\r\n" + ((stack1 = lookupProperty(helpers, "each").call(depth0 != null ? depth0 : container.nullContext || {}, depth0 != null ? lookupProperty(depth0, "tags") : depth0, { "name": "each", "hash": {}, "fn": container.program(4, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 37, "column": 16 }, "end": { "line": 39, "column": 25 } } })) != null ? stack1 : "") + "            </span>\r\n";
...
(function () {
  ...
  templates['searchResult.hbs'] = template({ "1": function _(container, depth0, helpers, partials, data) {
      ...
      return "<li class=\"" + alias4((helper = (helper = lookupProperty(helpers, "type") || (depth0 != null ? lookupProperty(depth0, "type") : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "type", "hash": {}, "data": data, "loc": { "start": { "line": 1, "column": 11 }, "end": { "line": 1, "column": 19 } } }) : helper)) + "\" data-db-id=\"" + alias4((helper = (helper = lookupProperty(helpers, "_id") || (depth0 != null ? lookupProperty(depth0, "_id") : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "_id", "hash": {}, "data": data, "loc": { "start": { "line": 1, "column": 33 }, "end": { "line": 1, "column": 40 } } }) : helper)) + "\">\r\n    <div class=\"wrapper\">\r\n        <span class=\"type-circle\"></span>\r\n        <span class=\"search-container__results__name\">" + alias4((helper = (helper = lookupProperty(helpers, "name") || (depth0 != null ? lookupProperty(depth0, "name") : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "name", "hash": {}, "data": data, "loc": { "start": { "line": 4, "column": 54 }, "end": { "line": 4, "column": 62 } } }) : helper)) + "</span>\r\n        <span class=\"tags tags--float-right\">\r\n" + ((stack1 = lookupProperty(helpers, "each").call(alias1, depth0 != null ? lookupProperty(depth0, "tags") : depth0, { "name": "each", "hash": {}, "fn": container.program(1, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 6, "column": 12 }, "end": { "line": 8, "column": 21 } } })) != null ? stack1 : "") + "        </span>\r\n    </div>\r\n</li>";
    }, "useData": true });
})();
...
(function () {
  ...
  templates['track.hbs'] = template({ "1": function _(container, depth0, helpers, partials, data) {
      ...
      return "            <span>Source:\r\n                <span class=\"source\">" + container.escapeExpression((helper = (helper = lookupProperty(helpers, "source") || (depth0 != null ? lookupProperty(depth0, "source") : depth0)) != null ? helper : container.hooks.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : container.nullContext || {}, { "name": "source", "hash": {}, "data": data, "loc": { "start": { "line": 31, "column": 37 }, "end": { "line": 31, "column": 47 } } }) : helper)) + "</span>\r\n            </span>\r\n            <br>\r\n";
    }, "3": function _(container, depth0, helpers, partials, data) {
      var stack1,
          lookupProperty = container.lookupProperty || function (parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
      ...
      return "<div class=\"section section--track\" data-atmosphere=\"" + alias4((helper = (helper = lookupProperty(helpers, "atmosphereId") || (depth0 != null ? lookupProperty(depth0, "atmosphereId") : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "atmosphereId", "hash": {}, "data": data, "loc": { "start": { "line": 1, "column": 53 }, "end": { "line": 1, "column": 69 } } }) : helper)) + "\">\r\n    <div class=\"section__heading\">\r\n        <h4 class=\"section__heading__title\">\r\n            <span class=\"section__heading__title__text\">" + alias4((helper = (helper = lookupProperty(helpers, "name") || (depth0 != null ? lookupProperty(depth0, "name") : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "name", "hash": {}, "data": data, "loc": { "start": { "line": 4, "column": 56 }, "end": { "line": 4, "column": 64 } } }) : helper)) + "</span>\r\n        </h4>\r\n        <div class=\"btn btn--delete btn--medium btn--inverted btn--header\">\r\n            <div class=\"btn__inner\">\r\n            <i class=\"fa fa-times\" aria-hidden=\"true\"></i>\r\n            </div>\r\n        </div>\r\n        <div class=\"btn btn--reorder btn--reorder-up btn--medium btn--inverted btn--header\">\r\n            <div class=\"btn__inner\">\r\n            <i class=\"fa fa-arrow-up\" aria-hidden=\"true\"></i>\r\n            </div>\r\n        </div>\r\n        <div class=\"btn btn--reorder btn--reorder-down btn--medium btn--inverted btn--header\">\r\n            <div class=\"btn__inner\">\r\n            <i class=\"fa fa-arrow-down\" aria-hidden=\"true\"></i>\r\n            </div>\r\n        </div>\r\n        <div class=\"btn btn--drag btn--medium btn--inverted btn--header\">\r\n            <div class=\"btn__inner\">\r\n            <i class=\"fa fa-arrows-alt\" aria-hidden=\"true\"></i>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"section__body\">\r\n        <div class=\"wrapper\">\r\n" + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "source") : depth0, { "name": "if", "hash": {}, "fn": container.program(1, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 29, "column": 12 }, "end": { "line": 34, "column": 19 } } })) != null ? stack1 : "") + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "tags") : depth0, { "name": "if", "hash": {}, "fn": container.program(3, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 35, "column": 12 }, "end": { "line": 41, "column": 19 } } })) != null ? stack1 : "") + "            <div class=\"section__flex\">\r\n                <div class=\"volume section__flex__item\">\r\n                    <input type=\"range\" min=\"0\" max=\"1\" value=\"1\" step=\"0.05\">\r\n                    <label class=\"checkbox checkbox--custom volume__mute\">\r\n                        <input type=\"checkbox\" class=\"btn--mute\">\r\n                        <div class=\"checkbox__indicator checkbox__indicator--medium\"></div>\r\n                        <div class=\"checkbox--custom__on\"><i class=\"fa fa-volume-off\" aria-hidden=\"true\"></i></div>\r\n                        <div class=\"checkbox--custom__off\"><i class=\"fa fa-volume-up\" aria-hidden=\"true\"></i></div>\r\n                    </label>\r\n                </div>\r\n                <!-- TODO: disabled/enabled -->\r\n                <div class=\"section__flex__item\">\r\n                    <div class=\"btn--play btn btn--rounded btn--medium\">\r\n                        <div class=\"btn__inner\">\r\n                            <i class=\"fa fa-play\" aria-hidden=\"true\"></i>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"btn--stop btn btn--rounded btn--medium\">\r\n                        <div class=\"btn__inner\">\r\n                            <i class=\"fa fa-stop\" aria-hidden=\"true\"></i>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>";
    }, "useData": true });
})();
