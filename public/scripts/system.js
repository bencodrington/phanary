...
var modify = {};
modify.$collection = (0, _jquery2.default)('input[type=radio][name=collection]');
modify.$fields = (0, _jquery2.default)('.modify__field');
...
modify.$button = (0, _jquery2.default)('.modify__btn');
modify.$delete = (0, _jquery2.default)('.modify__btn-delete');
modify.$subtitle = (0, _jquery2.default)('.modify .system-section__subtitle');
var $displayTable = (0, _jquery2.default)('#display-table');

modify.$fields.hide();
modify.$delete.hide();

//  The set of all field names for the different types of items (atmospheres, loops, oneshots)
var fieldNames = ['_id', 'name', 'tags', 'oneshots', 'tracks', 'source', 'filename', 'samples'];

var $sections = (0, _jquery2.default)('.system__section');
var $inputs = (0, _jquery2.default)('.system__section__input');
var $loopDropbox = (0, _jquery2.default)('#loop-dropbox');
var $oneshotDropbox = (0, _jquery2.default)('#oneshot-dropbox');
var $saveBtn = (0, _jquery2.default)('#save-btn');
var $deleteBtn = (0, _jquery2.default)('#delete-btn');
hideDropboxes();
hideAll();
events();
...
function events() {
    ...
    (0, _jquery2.default)('.system-sidebar__section__title').on('click', function (event) {
    ...
    (0, _jquery2.default)('.sidebar').on('click', function (event) {
        if ((0, _jquery2.default)(event.target).is('.sidebar')) {
            hideAll(); //  Event was triggered directly on the sidebar background
        }
    });

    (0, _jquery2.default)('.system__section').on('dragover', function (event) {
        event.preventDefault();
    });

    (0, _jquery2.default)('.system__section__dropbox').on('dragover', function (event) {
    ...
    (0, _jquery2.default)('.system__btn--add').on('click', function (event) {
...
function hideAll() {
    (0, _jquery2.default)('.system-sidebar__list').hide(); //  Hide all sidebar lists
    $sections.hide(); //  Hide all fields and inputs
    (0, _jquery2.default)('.system__record-control').hide(); //  Hide 'Save' and 'Delete' buttons
}
...
function refreshCollection(collection) {
    ...
    var $list = (0, _jquery2.default)('.system-sidebar__list').filter(function (i, element) {
        return (0, _jquery2.default)(element).data('collection') === collection;
    });
...
function loadCollection(collection, $list) {
    ...
    _jquery2.default.getJSON('/system/get', query, function (results) {
...
function displayCollection(results, collection, $list) {
    ...
    _jquery2.default.each(results, function (i, result) {
        ...
        (0, _jquery2.default)('<li>', { 'draggable': collection !== 'atmospheres', 'data-id': result._id, 'data-collection': collection }).on('dragstart', function (event) {
            liDragStart(event);
        }).append((0, _jquery2.default)('<span>').text(result.name)).
...
function switchToCollection(collection) {
    var $section;
    _jquery2.default.each($sections, function (i, section) {
        $section = (0, _jquery2.default)(section);
...
function getInputs() {
    return $sections.filter(':visible').find('.system__section__input');
}
...
function populateInputs(data) {
    ...
    var $field;
    for (var key in data) {
        if (_jquery2.default.inArray(key, fieldNames) >= 0) {
...
function saveItem() {
    ...
    $visibleInputs.each(function (i, element) {
        name = element.getAttribute('name');
        if (name === '_id') {
            query.id = element.value;
        } else {
            query[name] = readValue((0, _jquery2.default)(element), name);
        }
    });
...
function deleteItem() {
    ...
    // Cache system__section__inputs in the currently visible section
    var $visibleInputs = getInputs();
    var $idField = $visibleInputs.filter(function (i, element) {
        return element.getAttribute('name') === '_id';
    });
    query.id = $idField.val();
    _jquery2.default.post('/system/delete', query, function () {
        hideAll();
...
function writeValue($field, key, value) {
    if ($field.is('input')) {
        //  Simple one-line textbox
        $field.val(value);
    } else if ($field.is('textarea')) {
        //  Multi-line textbox, requires parsing
        if (key === 'samples') {
    ...
    } else if ($field.is('table')) {
        //  Atmosphere 'Loops' or 'One-Shots' special field
...
function parseLoopTable($field) {
    var loops = [];
    var loop;
    $field.children().each(function (i, element) {
        loop = {};
        loop.id = element.getAttribute('data-id');
        loop.volume = (0, _jquery2.default)(element).find('input[name=volume]').val();
        loops.push(loop);
    });
...
function parseAtmosphereChildren(children, collection) {
    var $child;
    var $children = (0, _jquery2.default)();
    _jquery2.default.each(children, function (i, child) {
...
function generateChildHTML(child, collection) {
    ...
    $remove = (0, _jquery2.default)('<td>').append((0, _jquery2.default)('<div>', { 'class': 'btn btn btn--rounded btn--medium' }).append((0, _jquery2.default)('<div>', { 'class': 'btn__inner' }).append((0, _jquery2.default)('<i>', { 'class': 'fa fa-close', 'aria-hidden': 'true' })))).on('click', function (event) {
        $child.remove();
        invalidateRecord();
    });
    $name = (0, _jquery2.default)('<td>').text('Loading name...');
    if (collection === "oneshots") {
        $indices = (0, _jquery2.default)('<td>').append((0, _jquery2.default)('<span>').text('MIN: '), (0, _jquery2.default)('<span>').addClass('system__timestep').text('n/a'), (0, _jquery2.default)('<input>', { 'type': 'number', 'name': 'minIndex', 'min': 0, 'max': _OneShotTimesteps2.default.length - 1, 'value': child.minIndex }), (0, _jquery2.default)('<span>').text('MAX: '), (0, _jquery2.default)('<span>').addClass('system__timestep').text('n/a'), (0, _jquery2.default)('<input>', { 'type': 'number', 'name': 'maxIndex', 'min': 0, 'max': _OneShotTimesteps2.default.length - 1, 'value': child.maxIndex }));
        $indices.children('input').each(function (i, element) {
            updateTimestep(element);
        });
        $indices.children('input').on('input', function (event) {
            updateTimestep(event.target);
        });
    };
    $child = (0, _jquery2.default)('<tr>', { 'data-id': child.id }). // Store id value for future updating
    append($name, $slider);
    if (collection === "oneshots") {
...
function injectName(collection, id, $field) {
    fetchItem(collection, id, function (result) {
...
function updateTimestep(inputHTML) {
    var $span = (0, _jquery2.default)(inputHTML).prev('.system__timestep'); // Find text element to update
    $span.text(_OneShotTimesteps2.default[inputHTML.value]);
}
...
function onDropboxDrop(event) {
    ...
    var $table = (0, _jquery2.default)('.system__atmosphere-children').filter(function (i, element) {
        return (0, _jquery2.default)(element).data('collection') === collection;
    });
    $table.append($child);
}
...
modify.$button.on('click', function () {
    if ((0, _jquery2.default)(this).find('span').text() == 'Insert') {
        insertData();
    } else {
        updateData();
    }
